...
def handle_message_enter(message):
    intents = {
        "last_conversation": ["последний разговор", "предыдущие сообщения", "последнее общение", "все диалоги", "мои последние сообщения"],
        "user_list": ["список пользователей", "со мной", "общались с тобой", "все юзеры, ", "все кто разговаривал", "кто с тобой общался?", "кто с тобой говорил"],
        ...
        "request_oder_users": ["другие", "другие пользователи", "запросы других коллег юзеров пользователей", "других юзеров", "вопросы других", "о чем говорили другие коллеги", "диалоги других","с тобой еще разговаривал"]
    }
